...
public class ModelLimitTests
{
    ...
    public void MaxQuantity_AppliesToTotalModels_NotUnitInstances()
    {
        ...
        {
            new UnitConfiguration(unit, unit.ResolveVariant(null), 1, unit.Experience.First(), new Dictionary<string,int>(), new Dictionary<string,int>(), false, null),
            new UnitConfiguration(unit, unit.ResolveVariant(null), 1, unit.Experience.First(), new Dictionary<string,int>(), new Dictionary<string,int>(), false, null)
        };
        ...
        rosterConfigs.Clear();
        var full = new UnitConfiguration(unit, unit.ResolveVariant(null), 2, unit.Experience.First(), new Dictionary<string,int>(), new Dictionary<string,int>(), false, null);
